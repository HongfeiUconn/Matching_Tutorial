...
This tutorial uses an empirical example to describe matching strategy. The package was written by [Ruoqing Zhu](https://sites.google.com/site/teazrq/). The reference of the paper that put forward this package is recommended as 

> "Li H, Peng J, Li X, Stallaert J (2019) When More is Less: The Effect of Add-on Insurance on the Consumption of Professional Services"

For all the authors' information, please see:
[Hongfei Li](https://www.hongfei-business.com/)
[Jing Peng](https://www.business.uconn.edu/person/timothy-folta/)
[Xinxin Li](https://hongfeiuconn.github.io/personal-website/)
[Jan Stallaert](https://sites.google.com/site/teazrq/)
